...
%                end;end;end
               ...
               x = obj.CoordMinMax_D(1,1)+ (0.5 - nG)*obj.CellSize_D(1):...
                  obj.CellSize_D(1):...
                  obj.CoordMinMax_D(1,2) + (nG - 0.5)*obj.CellSize_D(1);
               y = obj.CoordMinMax_D(2,1)+ (0.5 - nG)*obj.CellSize_D(2):...
                  obj.CellSize_D(2):...
                  obj.CoordMinMax_D(2,2) + (nG - 0.5)*obj.CellSize_D(2);
               z = obj.CoordMinMax_D(3,1)+ (0.5 - nG)*obj.CellSize_D(3):...
                  obj.CellSize_D(3):...
                  obj.CoordMinMax_D(3,2) + (nG - 0.5)*obj.CellSize_D(3);
