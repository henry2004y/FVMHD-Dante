classdef FaceFlux < handle
   ...
   methods (Access = public)
      function obj = FaceFlux()
         ...
         if Parameters.UseGPU
            obj.LFlux_XV = Inf([GridSize+[1 0 0],nVar],'gpuArray');
            obj.RFlux_XV = Inf([GridSize+[1 0 0],nVar],'gpuArray');
            obj.LFlux_YV = Inf([GridSize+[0 1 0],nVar],'gpuArray');
            obj.RFlux_YV = Inf([GridSize+[0 1 0],nVar],'gpuArray');
            obj.LFlux_ZV = Inf([GridSize+[0 0 1],nVar],'gpuArray');
            obj.RFlux_ZV = Inf([GridSize+[0 0 1],nVar],'gpuArray');
         else
            obj.LFlux_XV = Inf([GridSize+[1 0 0],nVar]);
            obj.RFlux_XV = Inf([GridSize+[1 0 0],nVar]);
            obj.LFlux_YV = Inf([GridSize+[0 1 0],nVar]);
            obj.RFlux_YV = Inf([GridSize+[0 1 0],nVar]);
            obj.LFlux_ZV = Inf([GridSize+[0 0 1],nVar]);
            obj.RFlux_ZV = Inf([GridSize+[0 0 1],nVar]);
         end
      end
   end
   ...
   methods (Access = private)
      function obj = get_physical_flux(obj,faceValue)
         ...
         % Density flux
         obj.LFlux_XV(:,:,:,Rho_) = LState_XV(:,:,:,Ux_);
         obj.RFlux_XV(:,:,:,Rho_) = RState_XV(:,:,:,Ux_);
         obj.LFlux_YV(:,:,:,Rho_) = LState_YV(:,:,:,Uy_);
         obj.RFlux_YV(:,:,:,Rho_) = RState_YV(:,:,:,Uy_);
         obj.LFlux_ZV(:,:,:,Rho_) = LState_ZV(:,:,:,Uz_);
         obj.RFlux_ZV(:,:,:,Rho_) = RState_ZV(:,:,:,Uz_);
         ...
         obj.LFlux_XV(:,:,:,Bx_) = 0;
         obj.RFlux_XV(:,:,:,Bx_) = 0;
         obj.LFlux_XV(:,:,:,By_) = LState_XV(:,:,:,Ux_).*...
            LState_XV(:,:,:,By_) - LState_XV(:,:,:,Bx_).*...
            LState_XV(:,:,:,Uy_);
         obj.RFlux_XV(:,:,:,By_) = RState_XV(:,:,:,Ux_).*...
            RState_XV(:,:,:,By_) - RState_XV(:,:,:,Bx_).*...
            RState_XV(:,:,:,Uy_);
         obj.LFlux_XV(:,:,:,Bz_) = LState_XV(:,:,:,Ux_).*...
            LState_XV(:,:,:,Bz_) - LState_XV(:,:,:,Bx_).*...
            LState_XV(:,:,:,Uz_);
         obj.RFlux_XV(:,:,:,Bz_) = RState_XV(:,:,:,Ux_).*...
            RState_XV(:,:,:,Bz_) - RState_XV(:,:,:,Bx_).*...
            RState_XV(:,:,:,Uz_);
         
         obj.LFlux_YV(:,:,:,Bx_) = LState_YV(:,:,:,Uy_).*...
            LState_YV(:,:,:,Bx_) - LState_YV(:,:,:,By_).*...
            LState_YV(:,:,:,Ux_);
         obj.RFlux_YV(:,:,:,Bx_) = RState_YV(:,:,:,Uy_).*...
            RState_YV(:,:,:,Bx_) - RState_YV(:,:,:,By_).*...
            RState_YV(:,:,:,Ux_);
         obj.LFlux_YV(:,:,:,By_) = 0;
         obj.RFlux_YV(:,:,:,By_) = 0;
         obj.LFlux_YV(:,:,:,Bz_) = LState_YV(:,:,:,Uy_).*...
            LState_YV(:,:,:,Bz_) - LState_YV(:,:,:,By_).*...
            LState_YV(:,:,:,Uz_);
         obj.RFlux_YV(:,:,:,Bz_) = RState_YV(:,:,:,Uy_).*...
            RState_YV(:,:,:,Bz_) - RState_YV(:,:,:,By_).*...
            RState_YV(:,:,:,Uz_);
         
         obj.LFlux_ZV(:,:,:,Bx_) = LState_ZV(:,:,:,Uz_).*...
            LState_ZV(:,:,:,Bx_) - LState_ZV(:,:,:,Bz_).*...
            LState_ZV(:,:,:,Ux_);
         obj.RFlux_ZV(:,:,:,Bx_) = RState_ZV(:,:,:,Uz_).*...
            RState_ZV(:,:,:,Bx_) - RState_ZV(:,:,:,Bz_).*...
            RState_ZV(:,:,:,Ux_);
         obj.LFlux_ZV(:,:,:,By_) = LState_ZV(:,:,:,Uz_).*...
            LState_ZV(:,:,:,By_) - LState_ZV(:,:,:,Bz_).*...
            LState_ZV(:,:,:,Uy_);
         obj.RFlux_ZV(:,:,:,By_) = RState_ZV(:,:,:,Uz_).*...
         ...
         if strcmp(Parameters.Scheme,'Rusanov')
            ...
            if ~Parameters.UseConservative
               obj.Flux_XV = obj.Flux_XV - ...
                  0.5*obj.Cmax_XF.*(RState_XV - LState_XV);
               ...
               obj.Flux_XV(:,:,:,Rho_:Bz_) = ...
                  obj.Flux_XV(:,:,:,Rho_:Bz_) - ...
                  0.5*obj.Cmax_XF.*(RState_XV(:,:,:,Rho_:Bz_) - ...
                  LState_XV(:,:,:,Rho_:Bz_));
               ...
               obj.Flux_ZV(:,:,:,Rho_:Bz_) = ...
                  obj.Flux_ZV(:,:,:,Rho_:Bz_) - ...
                  0.5*obj.Cmax_ZF.*(RState_ZV(:,:,:,Rho_:Bz_) - ...
                  LState_ZV(:,:,:,Rho_:Bz_));
      ...
      function obj = get_HLLE_flux(obj,faceValue)
         ...
         if ~Parameters.UseConservative
            ...
            obj.Flux_XV(:,:,:,E_) = obj.Flux_XV(:,:,:,E_) - ...
               0.5*(smax_XF + smin_XF)./(smax_XF - smin_XF).*...
               (obj.RFlux_XV(:,:,:,E_) - obj.LFlux_XV(:,:,:,E_)) + ...
               smax_XF.*smin_XF./(smax_XF - smin_XF).* ( ...
               (RState_XV(:,:,:,P_) / (gamma-1) + ...
               0.5./RState_XV(:,:,:,Rho_).*...
               sum(RState_XV(:,:,:,U_).^2,4) + ...
            ...
            obj.Flux_YV(:,:,:,Rho_:Bz_) = obj.Flux_YV(:,:,:,Rho_:Bz_) - ...
               0.5*(smax_YF + smin_YF)./(smax_YF - smin_YF).*...
               (obj.RFlux_YV(:,:,:,Rho_:Bz_) - obj.LFlux_YV(:,:,:,Rho_:Bz_))+ ...
               smax_YF.*smin_YF./(smax_YF - smin_YF).*...
               (RState_YV(:,:,:,Rho_:Bz_) - LState_YV(:,:,:,Rho_:Bz_));
            obj.Flux_YV(:,:,:,E_) = obj.Flux_YV(:,:,:,E_) - ...
               0.5*(smax_YF + smin_YF)./(smax_YF - smin_YF).*...
               (obj.RFlux_YV(:,:,:,E_) - obj.LFlux_YV(:,:,:,E_)) + ...
               smax_YF.*smin_YF./(smax_YF - smin_YF).* (...
               (RState_YV(:,:,:,P_) / (gamma-1) + ...
               0.5./RState_YV(:,:,:,Rho_).*...
               sum(RState_YV(:,:,:,U_).^2,4) + ...
            ...
            obj.Flux_ZV(:,:,:,Rho_:Bz_) = obj.Flux_ZV(:,:,:,Rho_:Bz_) - ...
               0.5*(smax_ZF + smin_ZF)./(smax_ZF - smin_ZF).*...
               (obj.RFlux_ZV(:,:,:,Rho_:Bz_) - obj.LFlux_ZV(:,:,:,Rho_:Bz_)) + ...
               smax_ZF.*smin_ZF./(smax_ZF - smin_ZF).*...
               (RState_ZV(:,:,:,Rho_:Bz_) - LState_ZV(:,:,:,Rho_:Bz_));
            obj.Flux_ZV(:,:,:,E_) = obj.Flux_ZV(:,:,:,E_) - ...
               0.5*(smax_ZF + smin_ZF)./(smax_ZF - smin_ZF).*...
               (obj.RFlux_ZV(:,:,:,E_) - obj.LFlux_ZV(:,:,:,E_)) + ...
               smax_ZF.*smin_ZF./(smax_ZF - smin_ZF).* (...
               (RState_ZV(:,:,:,P_) / (gamma-1) + ...
               0.5./RState_ZV(:,:,:,Rho_).*...
               sum(RState_ZV(:,:,:,U_).^2,4) + ...
      ...
      function [cmax_XF,cmax_YF,cmax_ZF] = get_speed_max(obj,faceValue)
         ...
         % This is only needed for physical faces.
         %-----------------------------------------------------------------
         gamma = Const.gamma;
